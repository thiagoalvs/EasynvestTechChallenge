...
namespace EasynvestTechDemo.Tests.Infrastructure
{
    ...
    public class TesouroDiretoServiceTest
    {
        ...
        public void Initialize()
        {
            ...
            {
                cfg.CreateMap<TesouroDiretoServiceResponseItem, InvestmentDTO>();
            }));
        ...
        public async Task DeveRetornarInvestimentosSemCache()
        {
            ...
            mockHttpMessageHandler.Protected()
                ...
                .ReturnsAsync(new HttpResponseMessage
                {
                    ...
                    Content = new StringContent(JsonConvert.SerializeObject(new TesouroDiretoServiceResponse() { Investments = new List<TesouroDiretoServiceResponseItem>() { new TesouroDiretoServiceResponseItem() } })),
                });
